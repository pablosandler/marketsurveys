...
public interface MarketSurveyService {
    ...
    List<MarketSurvey> getAvailableSurveys(Long requester, Long provider, String subject, String country, Sex sex, Long ageFrom, Long ageTo, String incomeCurrency, Long incomeFrom, Long incomeTo);
}
